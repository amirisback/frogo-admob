...
android {
    ...
    namespace = ProjectSetting.PROJECT_LIB_ID_GOOGLE_ADMOB
    ...
    publishing {
        publications {
            ...
            register("release", MavenPublication::class) {
                ...
                groupId = ProjectSetting.PROJECT_LIB_ID_GOOGLE_ADMOB

                // Library Name / Module Name (Example : "androidfirstlib")
                // NOTE : Different ArtifactId For Each Library / Module, So That Each Library Is Not Overwritten
                artifactId = ProjectSetting.MODULE_NAME_GOOGLE_ADMOB
